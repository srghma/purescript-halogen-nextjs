...
findJsonFromScriptElement querySelector = do
  ...
  let (htmlScriptElement :: Maybe Web.HTML.HTMLScriptElement.HTMLScriptElement) = Web.HTML.HTMLScriptElement.fromHTMLElement element
  ...
  let (json :: Either String ArgonautCore.Json) = ArgonautCore.jsonParser text
