module Api.Object.CreatePostPayload where
...
import Api.Scopes
  (Scope__CreatePostPayload, Scope__Post, Scope__User, Scope__PostsEdge)
import Data.Maybe (Maybe)
import Api.Enum.PostsOrderBy (PostsOrderBy)
import Type.Row (type (+))

clientMutationId :: SelectionSet Scope__CreatePostPayload (Maybe String)
