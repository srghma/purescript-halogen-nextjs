module Classes.RMWC.Badge (rmwc_badge, rmwc_badge____no_content, rmwc_badge____exited, rmwc_badge____align_start, rmwc_badge____align_end, rmwc_badge____align_inline, rmwc_badge_anchor) where
