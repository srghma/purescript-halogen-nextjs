exports.makeExtendSchemaPlugin = require("graphile-utils").makeExtendSchemaPlugin

exports.gql = require("graphile-utils").gql
      ...
      async login(
        ...
        try {
          ...
          const {
            ...
            `select users.* from app_private.web_login($1, $2) users where not (users is null)`,
            [username, password]
          );
