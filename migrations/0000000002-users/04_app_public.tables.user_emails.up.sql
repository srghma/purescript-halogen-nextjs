...
grant select on app_public.user_emails to app_visitor;
grant insert (email) on app_public.user_emails to app_visitor;
grant delete on app_public.user_emails to app_visitor;
